...
-- from benjibot-core.cabal, and output to stdout in a JSON friendly list.
module Main where
...
import Text.PrettyPrint (brackets, comma, doubleQuotes, render)
import Prelude hiding (readFile)

main = do
  bs <- readFile "./benjibot-core/benjibot-core.cabal"
