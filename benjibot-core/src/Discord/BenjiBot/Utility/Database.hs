-- |
-- Module      : Discord.BenjiBot.Utility.Database
...
import Discord.BenjiBot.Utility (EnvDatabaseDiscord, liftSql)

insert :: (Sql.PersistEntity record, Sql.PersistEntityBackend record ~ Sql.SqlBackend, Sql.SafeToInsert record) => record -> EnvDatabaseDiscord d (Sql.Key record)
insert r = liftSql $ Sql.insert r

insert_ :: (Sql.PersistEntity record, Sql.PersistEntityBackend record ~ Sql.SqlBackend, Sql.SafeToInsert record) => record -> EnvDatabaseDiscord d ()
insert_ r = liftSql $ Sql.insert_ r

insertMany :: (Sql.PersistEntity record, Sql.PersistEntityBackend record ~ Sql.SqlBackend, Sql.SafeToInsert record) => [record] -> EnvDatabaseDiscord d [Sql.Key record]
insertMany r = liftSql $ Sql.insertMany r

insertMany_ :: (Sql.PersistEntity record, Sql.PersistEntityBackend record ~ Sql.SqlBackend, Sql.SafeToInsert record) => [record] -> EnvDatabaseDiscord d ()
insertMany_ r = liftSql $ Sql.insertMany_ r

insertEntityMany :: (Sql.PersistEntity record, Sql.PersistEntityBackend record ~ Sql.SqlBackend, Sql.SafeToInsert record) => [Sql.Entity record] -> EnvDatabaseDiscord d ()
insertEntityMany r = liftSql $ Sql.insertEntityMany r

insertEntity :: (Sql.PersistEntity e, Sql.PersistEntityBackend e ~ Sql.SqlBackend, Sql.SafeToInsert e) => e -> EnvDatabaseDiscord d (Sql.Entity e)
insertEntity r = liftSql $ Sql.insertEntity r

insertEntityUnique :: (Sql.PersistEntity record, Sql.PersistEntityBackend record ~ Sql.SqlBackend, Sql.SafeToInsert record) => record -> EnvDatabaseDiscord d (Maybe (Sql.Entity record))
insertEntityUnique r = liftSql $ Sql.insertUniqueEntity r

insertUnique :: (Sql.PersistEntity record, Sql.PersistEntityBackend record ~ Sql.SqlBackend, Sql.SafeToInsert record) => record -> EnvDatabaseDiscord d (Maybe (Sql.Key record))
...
upsert :: (Sql.OnlyOneUniqueKey record, Sql.PersistEntityBackend record ~ Sql.SqlBackend, Sql.SafeToInsert record) => record -> [Sql.Update record] -> EnvDatabaseDiscord d (Sql.Entity record)
