-- |
-- Module      : Discord.BenjiBot.Utility.Random
...
module Discord.BenjiBot.Utility.Random (chooseOne, chooseOneWithDefault, chooseOneWeighted, chooseOneWeightedWithDefault) where

import Control.Monad.Exception (MonadException (throw))
import Data.List (find)
import Data.Maybe (fromJust)
import System.Random (randomRIO)
import Discord.BenjiBot.Utility.Exception (BotException (RandomException), catchBot)
