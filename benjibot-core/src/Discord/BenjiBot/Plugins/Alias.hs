...
-- |
-- Module      : Discord.BenjiBot.Plugins.Alias
...
module Discord.BenjiBot.Plugins.Alias (alias, Alias (..), getAliases) where
...
import Discord.BenjiBot.Internal.Types (AliasType (..))
import Discord.BenjiBot.Utility
import Discord.BenjiBot.Utility.Database (deleteBy, exists)
import Discord.BenjiBot.Utility.Discord (sendMessage)
import Discord.BenjiBot.Utility.Permission (requirePermission)
import Discord.BenjiBot.Utility.SmartParser (PComm (parseComm), Quoted (..), WithError (..))
