-- |
-- Module      : Discord.BenjiBot.Plugins.Roll.Plugin
...
module Discord.BenjiBot.Plugins.Roll.Plugin (rollPlugin) where
...
import Discord.BenjiBot.Internal.Cache (getFontMap)
import Discord.BenjiBot.Internal.Handler.Command (parseValue)
import Discord.BenjiBot.Plugins.Roll.Dice
import Discord.BenjiBot.Plugins.Roll.Dice.DiceData
import Discord.BenjiBot.Plugins.Roll.Dice.DiceStats (getStats, rangeExpr)
import Discord.BenjiBot.Plugins.Roll.Dice.DiceStatsBase (distributionByteString)
import Discord.BenjiBot.Utility
import Discord.BenjiBot.Utility.Discord (Format (Code), formatText, sendCustomMessage, sendMessage, toMention')
import Discord.BenjiBot.Utility.Exception (BotException (EvaluationException), throwBot)
...
To see a full list of uses, options and limitations, please go to <https://github.com/l0negamer/benjibot/blob/stable/docs/Roll.md>.
