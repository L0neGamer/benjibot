-- |
-- Module      : Discord.BenjiBot.Plugins.Roll.Dice
...
module Discord.BenjiBot.Plugins.Roll.Dice (evalProgram, evalInteger, evalList, ListValues (..), defaultRoll, ParseShow (parseShow), integerFunctionsList, listFunctionsList, maximumListLength, maximumRNG, Converter (promote)) where
...
import Discord.BenjiBot.Plugins.Roll.Dice.DiceEval (ParseShow (parseShow), evalInteger, evalList, evalProgram, maximumListLength, maximumRNG)
import Discord.BenjiBot.Plugins.Roll.Dice.DiceFunctions (integerFunctionsList, listFunctionsList)
