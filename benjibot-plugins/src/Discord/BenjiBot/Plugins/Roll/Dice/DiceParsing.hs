...
-- |
-- Module      : Discord.BenjiBot.Plugins.Roll.Dice.DiceParsing
...
module Discord.BenjiBot.Plugins.Roll.Dice.DiceParsing () where
...
import Discord.BenjiBot.Utility.SmartParser (CanParse (..), (<??>))
import Discord.BenjiBot.Utility.Types (Parser)
