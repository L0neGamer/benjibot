...
-- |
-- Module      : Discord.BenjiBot.Plugins.Roll.Dice.DiceData
...
-- `Discord.BenjiBot.Plugins.Roll.Dice` to see the regex for this and brief explanations
-- for each data type.
module Discord.BenjiBot.Plugins.Roll.Dice.DiceData where

import Data.Map as M (Map, fromList)
import Data.Text (Text)
import Data.Tuple (swap)
import Discord.BenjiBot.Plugins.Roll.Dice.DiceFunctions (FuncInfo, FuncInfoBase)
