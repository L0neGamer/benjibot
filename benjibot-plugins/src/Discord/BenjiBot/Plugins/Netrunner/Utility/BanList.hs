-- |
-- Module      : Discord.BenjiBot.Plugins.Netrunner.Cycle
...
-- Portability : POSIX
--
-- Handles the representation of Netrunner ban lists in Discord.BenjiBot.
module Discord.BenjiBot.Plugins.Netrunner.Utility.BanList where

import Data.Map (lookup)
import Data.Maybe (mapMaybe)
import Discord.BenjiBot.Plugins.Netrunner.Type.BanList
import Discord.BenjiBot.Plugins.Netrunner.Type.Card (Card)
import qualified Discord.BenjiBot.Plugins.Netrunner.Type.Card as Card
import Discord.BenjiBot.Plugins.Netrunner.Type.NrApi (NrApi (NrApi, banLists, cards))
