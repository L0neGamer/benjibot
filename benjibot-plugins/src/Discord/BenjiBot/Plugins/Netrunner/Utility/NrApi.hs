-- |
-- Module      : Discord.BenjiBot.Plugins.Netrunner.NrApi
...
-- Portability : POSIX
--
-- Handles the representation of all Netrunner data in Discord.BenjiBot.
module Discord.BenjiBot.Plugins.Netrunner.Utility.NrApi (getNrApi) where
