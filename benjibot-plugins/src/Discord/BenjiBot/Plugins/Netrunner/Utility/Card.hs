-- |
-- Module      : Discord.BenjiBot.Plugins.Netrunner.Card
...
-- Portability : POSIX
--
-- Handles the representation of Netrunner cards in Discord.BenjiBot.
module Discord.BenjiBot.Plugins.Netrunner.Utility.Card
  ( toTitle,
    toText,
    toLink,
    toImage,
...
import qualified Discord.BenjiBot.Plugins.Netrunner.Type.Pack as Pack
import Discord.BenjiBot.Plugins.Netrunner.Utility.BanList (activeBanList, isBanned, isRestricted, toGlobalPenalty, toUniversalInfluence)
import Discord.BenjiBot.Plugins.Netrunner.Utility.Misc (formatNr)
