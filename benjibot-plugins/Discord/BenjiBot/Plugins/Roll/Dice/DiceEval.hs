-- |
-- Module      : Discord.BenjiBot.Plugins.Roll.Dice.DiceEval
...
-- expressions.
module Discord.BenjiBot.Plugins.Roll.Dice.DiceEval (ParseShow (parseShow), evalProgram, evalList, evalInteger, evaluationException, propagateException, maximumRNG, maximumListLength) where
