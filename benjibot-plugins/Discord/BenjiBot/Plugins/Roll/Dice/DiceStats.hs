-- |
-- Module      : Discord.BenjiBot.Plugins.Roll.Dice.DiceStats
...
-- expressions.
module Discord.BenjiBot.Plugins.Roll.Dice.DiceStats (rangeExpr, rangeListValues, getStats) where
...
import Discord.BenjiBot.Plugins.Roll.Dice.DiceEval
import Discord.BenjiBot.Plugins.Roll.Dice.DiceFunctions
import Discord.BenjiBot.Plugins.Roll.Dice.DiceStatsBase (Distribution)
import Discord.BenjiBot.Utility.Exception (catchBot)
