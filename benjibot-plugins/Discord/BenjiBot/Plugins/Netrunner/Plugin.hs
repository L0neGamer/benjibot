-- |
-- Module      : Discord.BenjiBot.Plugins.Netrunner.Plugin
...
module Discord.BenjiBot.Plugins.Netrunner.Plugin (netrunnerPlugin) where

import Control.Monad.IO.Class
import Control.Monad.Trans.Reader (ask)
import Data.Text (Text, pack, uncons)
import Discord.Types
import Discord.BenjiBot.Internal.Handler.Command ()
import Discord.BenjiBot.Plugins.Netrunner.Command.BanList
import Discord.BenjiBot.Plugins.Netrunner.Command.Custom
import Discord.BenjiBot.Plugins.Netrunner.Command.Find
import Discord.BenjiBot.Plugins.Netrunner.Command.Help (helpPageRoots)
import Discord.BenjiBot.Plugins.Netrunner.Command.Rules
import Discord.BenjiBot.Plugins.Netrunner.Command.Search
import Discord.BenjiBot.Plugins.Netrunner.Type.BanList (BanList (active), CardBan (..))
import qualified Discord.BenjiBot.Plugins.Netrunner.Type.BanList as BanList
import Discord.BenjiBot.Plugins.Netrunner.Type.Card (Card (code))
import Discord.BenjiBot.Plugins.Netrunner.Type.NrApi (NrApi (..))
import Discord.BenjiBot.Plugins.Netrunner.Utility.BanList (activeBanList, latestBanListActive, toMwlStatus)
import Discord.BenjiBot.Plugins.Netrunner.Utility.Card (toText)
import Discord.BenjiBot.Plugins.Netrunner.Utility.Embed
import Discord.BenjiBot.Plugins.Netrunner.Utility.NrApi (getNrApi)
import Discord.BenjiBot.Utility
import Discord.BenjiBot.Utility.Discord (formatFromEmojiName, sendEmbedMessage, sendMessage)
import Discord.BenjiBot.Utility.Embed (addColour)
import Discord.BenjiBot.Utility.Parser (inlineCommandHelper, keyValue, keyValuesSepOn)
import Discord.BenjiBot.Utility.SmartParser (PComm (parseComm), Quoted (Qu), RestOfInput (ROI), RestOfInput1 (ROI1), WithError (WErr))
