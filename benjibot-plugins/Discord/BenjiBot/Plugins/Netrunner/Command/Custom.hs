-- |
-- Module      : Discord.BenjiBot.Plugins.Netrunner.Custom
...
module Discord.BenjiBot.Plugins.Netrunner.Command.Custom (customCard) where
...
import Discord.BenjiBot.Utility.Search (FuzzyCosts (..), closestPairWithCosts, closestValue)
